    ...
    <strong>Price of Car:</strong> $${formatNumber(principal)}<br>
        <strong>Downpayment:</strong> $${formatNumber(downpayment)}<br>
            ...
            const filename = document.getElementById("filename").value || "loan_result";
                                ...
                                lines.push(`Summary: Your ${condition} car with a downpayment of $${downpayment} will cost you $${monthly} monthly, with a total interest of $${interest} and a total cost of $${total} over the span of ${loanYears} year(s).`);
